...
//           <button className=" p-2  mt-3 mb-2 text-white">Login</button>

//           <button className="bg-white px-4  mt-3 mb-2  rounded text-amber-600">
//             Register
//           </button>
//         </div>
//       </header>
...
//           {/* <!-- Images --> */}
//           <div className="carousel-inner w-full h-137.5">
